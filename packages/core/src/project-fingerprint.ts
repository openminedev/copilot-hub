...
export interface FingerprintChannel {
  kind?: unknown;
  id?: unknown;
}

export interface CreateProjectFingerprintOptions {
  runtimeId?: unknown;
  workspaceRoot?: unknown;
  providerKind?: unknown;
  channels?: FingerprintChannel[] | null;
}
...
export function createProjectFingerprint({
  ...
  providerKind,
  channels,
}: CreateProjectFingerprintOptions): string {
  const stable = {
...
function normalizeChannels(channels: FingerprintChannel[] | null | undefined) {
